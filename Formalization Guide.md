...
- Phase Specific Scaling: The amount of action usages depends on the phase:
  - `Odd: <Value>, Even: <Value>` to specify different multiplicities of ability use in even and odd nights. Set `<Value>` to one of the other scaling types, e.g. `Odd: x1, Even: x2`
